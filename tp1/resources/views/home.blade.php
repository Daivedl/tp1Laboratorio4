      ...
      <div class="container top-sect">
        <div class="navbar-header">
          <h1 class="navbar-brand">
            <a data-type='rd-navbar-brand'  href="./"><small>{{$empresas->denominacion}} <br>Empresa</small></a>
          </h1>
        ...
        <div class="help-box text-right">
          <p>Telefono</p>
          <a href="callto:#">{{$empresas->telefono}}</a>
          <small><span>Horario:</span>  <span>{{$empresas->horarioAtencion}}</span> PST M-Th; &nbsp;<span>{{$empresas->horarioAtencion}}</span> PST Fri</small>
        </div>
      </div>
